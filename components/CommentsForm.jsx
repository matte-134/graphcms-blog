  ...
  return (
    <div className='bg-white shadow-lg rounded-lg p-8 pb-12 mb-8'>
      ...
      <div className='grid grid-cols-1 gap-4 mb-4'>
        <textarea 
          ref={commentEl} 
          className='p-4 outline-none w-full rounded-lg focus:ring-2 focus:ring-gray-200 bg-grat-100 text-gray-700'
          placeholder='Comment'
          name='comment'
       />
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4'>
        <input 
          type='text' 
          ref={nameEl}
          className='py-2 px-4 outline-none w-full rounded-lg focus:ring-2 focus:ring-gray-200 bg-grat-100 text-gray-700'
          placeholder='Name'
          name='name' />
          <input 
          type='text' 
